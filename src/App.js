...
class App extends React.Component {
    ...
    render() {
        return (
                <div>
                <Textarea type = "text" name = "fml message" value = {this.state.input1} onChange = {this.handleInputOneChange.bind(this)}/>
                <Textarea type = "text" name = "fml message 2" value = {this.state.input2} onChange = {this.handleInputTwoChange.bind(this)}/>
